...
ifeq ($(config),debug)
  ...
  RESCOMP = windres
  TARGETDIR = bin/Debug
  TARGET = $(TARGETDIR)/arger
  OBJDIR = obj/Debug/arger
  DEFINES +=
  INCLUDES +=
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MD -MP $(DEFINES) $(INCLUDES)
  ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) --static
  ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) --static
...
$(OBJDIR)/arger.o: examples/arger.cpp
	@echo $(notdir $<)
